...
public class ExceptionEx4 {
	...
	public static void main(String[] args) {
		//참조형 초기화
		//null : 아직 값이 할당되지 않았음
		String data = null; // 실제로 할당하려면 String data="Hello";
		Account account = null; // 실제로 할당하려면 Account account = new Account();
		int[] arr = null; // 실제로 할당하려면 int arr[]=new int[5];
		...
		// 참조변수가 가리키고 있는 곳을 접근 시 java.lang.NullPointerException (값을 할당안했다고 생각하면 됨)
