...
//		sb2.append('d');
		...
		sb6 = sb5.deleteCharAt(4); // 0,1,2,3,4
		System.out.println("sb5 "+sb5);
		System.out.println("sb6 "+sb6);
		...
		str2 = "0123456789";
		// 출력 9876543210
		for (int i = str2.length()-1; i >= 0; i--) { //0을 9로 바꾸고 1을 8로 꾸고
		...
		System.out.println(sb5.reverse()); // 9876543210
		
		//setCharAt()
		sb5 = new StringBuffer("0123456");
		sb5.setCharAt(4, 'A');
		System.out.println("setCharAt() "+sb5 ); //0123A56
	}
}
