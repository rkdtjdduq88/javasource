...
public class ArrayEx1 {
	...
	public static void main(String[] args) {
		//*연속된* 공간에 int값을 저장할 수 있는 30개의 공간 생성
		...
		//배열선언, 생성, 초기화
		int score2[]= {98,88,65,45,85,65,99,100,50,80};
		System.out.println("5번째 학생 점수 : "+score2[4]); 
		System.out.println();
		
		
		double score3[]= {98.3,88.4,65.5,45.3,85.5,65,99,100,50,80};
...
//		System.out.println("10번째 학생 점수 : "+score3[9]);
		...
		System.out.println("score3.length의 길이 "+score3.length);
		...
		for (int i = 0; i < charr.length; i++) {
			System.out.println((i+1)+"글자 : "+charr[i]);
		}
