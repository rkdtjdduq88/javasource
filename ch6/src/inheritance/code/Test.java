...
import java.util.Scanner; //java.util 패키지에 있는 Scanner 클래스를 사용할 예정
import java.util.Date;
import exam.Account;


// jave.lang 패키지에 있는 클래스를 사용할 때는 import 구문이 필요없음
// 자주 사용하는 패키지이기 때문에 기본적으로 사용할 수 있도록 되어 있음 ex)String
...
// 제어자
// static(공통적인) - 멤버변수, 메서드, 초기화블럭     <== 앞에 붙음
// final - 클래스, 메소드, 멤버변수, 지역변수   <== 앞에 붙음
// static final - 공통상수
// abstract, ...
public class Test {
