 ...
 * 모든 메소드는 public abstract 임(생략 가능) ==> 추상메소드
 * 단, static 메소드와 default 메소드는 사용 가능(jdk8버전부터 가능)
 */
public interface Account {
	//The blank final field y may not have been initialized
    int x=0,y=0; //인터페이스에서 모든 멤버변수는 public static final(생략 가능) 임
    //void stop() {} //Abstract methods do not specify a body
    //모든 메소드는 public abstract 임(생략 가능)
    void stop();
